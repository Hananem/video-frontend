...
import { CaretRight, CaretLeft } from "phosphor-react"; // Import icons
import { getAllVideos } from "../../redux/videoSlice";
import DateDisplay from "../../pages/videos/DateDisplay"; // Assuming you have a DateDisplay component
...
const LatestVideos = () => {
  ...
  const latestVideos = videos?.slice(-10).reverse();
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      ...
      <div className="text-center mb-8">
        <h2 className="text-3xl font-bold text-gray-800">See Latest Videos</h2>
      </div>
